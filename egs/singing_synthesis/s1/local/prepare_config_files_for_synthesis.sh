...
duration_config_file=conf/test_dur_synth.conf
...
$SED -i s#'work:.*'#'work: %(TOPLEVEL)s/experiments/duration_model'# $duration_config_file

$SED -i s#'file_id_list:.*'#'file_id_list: %(data)s/'${FileIDList}# $duration_config_file
$SED -i s#'test_id_list\s*:.*'#'test_id_list: %(TOPLEVEL)s/experiments/test_synthesis/test_id_list.scp'# $duration_config_file
...
$SED -i s#'label_align\s*:.*'#'label_align: %(TOPLEVEL)s/experiments/test_synthesis/prompt-lab'# $duration_config_file
...
$SED -i s#'test_synth_dir\s*:.*'#'test_synth_dir: %(TOPLEVEL)s/experiments/test_synthesis/gen-lab'# $duration_config_file
...
acoustic_config_file=conf/test_synth.conf
