...
duration_config_file=conf/duration.conf
...
$SED -i s#'label_align:.*'#'label_align: %(TOPLEVEL)s/experiments/duration_model/data/label_'${Labels}# $duration_config_file
...
acoustic_config_file=conf/acoustic.conf
...
$SED -i s#'work:.*'#'work: %(TOPLEVEL)s/experiments/acoustic_model'# $acoustic_config_file
...
$SED -i s#'label_align:.*'#'label_align: %(TOPLEVEL)s/experiments/acoustic_model/data/label_'${Labels}# $acoustic_config_file
